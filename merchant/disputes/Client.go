...
func (c *Client) Get(disputeID string, context communication.CallContext) (dispute.Response, error) {
	...
	uri, err := c.apiResource.InstantiateURIWithContext("/{apiVersion}/{merchantId}/disputes/{disputeId}", pathContext)
	if err != nil {
...
func (c *Client) Submit(disputeID string, context communication.CallContext) (dispute.Response, error) {
	...
	uri, err := c.apiResource.InstantiateURIWithContext("/{apiVersion}/{merchantId}/disputes/{disputeId}/submit", pathContext)
	if err != nil {
		return resultObject, err
	}
...
func (c *Client) Cancel(disputeID string, context communication.CallContext) (dispute.Response, error) {
	...
	uri, err := c.apiResource.InstantiateURIWithContext("/{apiVersion}/{merchantId}/disputes/{disputeId}/cancel", pathContext)
	if err != nil {
		return resultObject, err
	}
