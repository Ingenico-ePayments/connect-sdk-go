...
// Documentation can be found at https://epayments-api.developer-ingenico.com/s2sapi/v1/en_US/go/captures/refund.html
//
// Can return any of the following errors:
...
// or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)
// * APIError if the Ingenico ePayments platform returned any other error
func (c *Client) Refund(captureID string, body refund.Request, context communication.CallContext) (refund.Response, error) {
